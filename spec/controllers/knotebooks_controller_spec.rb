...
describe KnotebooksController do
  ...
  #   @mock_knotebook ||= mock_model(Knotebook, stubs)
  # end
  # 
  # describe "GET index" do
  #   it "assigns all knotebooks as @knotebooks" do
  #     Knotebook.stub!(:find).with(:all).and_return([mock_knotebook])
  #     get :index
  #     assigns[:knotebooks].should == [mock_knotebook]
  #   end
  # end
  # 
  # describe "GET show" do
  #   it "assigns the requested knotebook as @knotebook" do
  #     Knotebook.stub!(:find).with("37").and_return(mock_knotebook)
  #     get :show, :id => "37"
  #     assigns[:knotebook].should equal(mock_knotebook)
  #   end
  # end
  # 
  # describe "GET new" do
  #   it "assigns a new knotebook as @knotebook" do
  #     Knotebook.stub!(:new).and_return(mock_knotebook)
  #     get :new
  #     assigns[:knotebook].should equal(mock_knotebook)
  #   end
  # end
  ...
  #       Knotebook.stub!(:new).with({'these' => 'params'}).and_return(mock_knotebook(:save => true))
  #       post :create, :knotebook => {:these => 'params'}
  #       assigns[:knotebook].should equal(mock_knotebook)
  #     end
  # 
  #     it "redirects to the created knotebook" do
  #       Knotebook.stub!(:new).and_return(mock_knotebook(:save => true))
  ...
  #       Knotebook.stub!(:new).with({'these' => 'params'}).and_return(mock_knotebook(:save => false))
  #       post :create, :knotebook => {:these => 'params'}
  #       assigns[:knotebook].should equal(mock_knotebook)
  #     end
  # 
  #     it "re-renders the 'new' template" do
  #       Knotebook.stub!(:new).and_return(mock_knotebook(:save => false))
  #       post :create, :knotebook => {}
  ...
  #       Knotebook.should_receive(:find).with("37").and_return(mock_knotebook)
  #       mock_knotebook.should_receive(:update_attributes).with({'these' => 'params'})
  #       put :update, :id => "37", :knotebook => {:these => 'params'}
  #     end
  # 
  #     it "assigns the requested knotebook as @knotebook" do
  #       Knotebook.stub!(:find).and_return(mock_knotebook(:update_attributes => true))
  #       put :update, :id => "1"
  #       assigns[:knotebook].should equal(mock_knotebook)
  #     end
  # 
  ...
  #       Knotebook.stub!(:find).and_return(mock_knotebook(:update_attributes => false))
  #       put :update, :id => "1"
  #       assigns[:knotebook].should equal(mock_knotebook)
  #     end
  # 
  ...
  #     Knotebook.stub!(:find).and_return(mock_knotebook(:destroy => true))
  #     delete :destroy, :id => "1"

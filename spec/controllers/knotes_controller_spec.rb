...
describe KnotesController do
  ...
  #   @mock_knote ||= mock_model(Knote, stubs)
  # end
  # 
  # describe "GET index" do
  #   it "assigns all knotes as @knotes" do
  #     Knote.stub!(:find).with(:all).and_return([mock_knote])
  #     get :index
  #     assigns[:knotes].should == [mock_knote]
  #   end
  # end
  # 
  # describe "GET show" do
  #   it "assigns the requested knote as @knote" do
  #     Knote.stub!(:find).with("37").and_return(mock_knote)
  #     get :show, :id => "37"
  #     assigns[:knote].should equal(mock_knote)
  #   end
  # end
  # 
  # describe "GET new" do
  #   it "assigns a new knote as @knote" do
  #     Knote.stub!(:new).and_return(mock_knote)
  #     get :new
  #     assigns[:knote].should equal(mock_knote)
  #   end
  # end
  ...
  #       Knote.stub!(:new).with({'these' => 'params'}).and_return(mock_knote(:save => true))
  #       post :create, :knote => {:these => 'params'}
  #       assigns[:knote].should equal(mock_knote)
  #     end
  # 
  #     it "redirects to the created knote" do
  #       Knote.stub!(:new).and_return(mock_knote(:save => true))
  #       post :create, :knote => {}
  ...
  #       Knote.stub!(:new).with({'these' => 'params'}).and_return(mock_knote(:save => false))
  #       post :create, :knote => {:these => 'params'}
  #       assigns[:knote].should equal(mock_knote)
  #     end
  # 
  #     it "re-renders the 'new' template" do
  #       Knote.stub!(:new).and_return(mock_knote(:save => false))
  #       post :create, :knote => {}
  ...
  #       Knote.should_receive(:find).with("37").and_return(mock_knote)
  #       mock_knote.should_receive(:update_attributes).with({'these' => 'params'})
  #       put :update, :id => "37", :knote => {:these => 'params'}
  #     end
  # 
  #     it "assigns the requested knote as @knote" do
  #       Knote.stub!(:find).and_return(mock_knote(:update_attributes => true))
  #       put :update, :id => "1"
  #       assigns[:knote].should equal(mock_knote)
  #     end
  # 
  ...
  #       Knote.stub!(:find).and_return(mock_knote(:update_attributes => false))
  #       put :update, :id => "1"
  #       assigns[:knote].should equal(mock_knote)
  #     end
  # 
  ...
  #     Knote.stub!(:find).and_return(mock_knote(:destroy => true))
  #     delete :destroy, :id => "1"
